...
import com.yandex.mobile.ads.nativeads.FeedAd
import com.yandex.mobile.ads.nativeads.FeedAdAdapter
import com.yandex.mobile.ads.nativeads.FeedAdAppearance
import com.yandex.mobile.ads.nativeads.FeedAdEventListener
import com.yandex.mobile.ads.nativeads.FeedAdLoadListener
...
internal class FeedAdsHelper(
    ...
    override fun load(callbackContext: CallbackContext) {
        ...
        feedAd?.preloadAd(getAdLoadListener()) // FIXME_SDK8: Auto-generated during migration, please review.
