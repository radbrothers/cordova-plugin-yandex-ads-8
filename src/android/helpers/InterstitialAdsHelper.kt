...
internal class InterstitialAdsHelper(
    ...
    override fun getLoader() = InterstitialAdLoader(cordova.context)

    private fun getAdLoadListener() = object : InterstitialAdLoadListener { // FIXME_SDK8: Auto-generated during migration, please review.
