...
internal class OpenAppAdsHelper(
    ...
    override fun getLoader() = AppOpenAdLoader(cordova.context)

    private fun getAdLoadListener() = object : AppOpenAdLoadListener { // FIXME_SDK8: Auto-generated during migration, please review.
